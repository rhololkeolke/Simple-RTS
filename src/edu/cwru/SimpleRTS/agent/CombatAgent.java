...
public class CombatAgent extends Agent{
	...
	public static String getUsage() {
		...
		return "It takes three parameters (--agentparam): a space separated array of enemy player numbers, a boolean for whether it should wander, and a boolean for verbosity";
	}
